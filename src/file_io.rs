...
/// 
pub type StableGraphImpl<NodeWeight, EdgeWeight> =
    petgraph::stable_graph::StableGraph<NodeWeight, EdgeWeight, Directed, DefaultIx>;

///
/// Module/Trait to serialize and deserialize a given Graph to a file.
/// Graph is implemented as petgraph::stable_graph::StableGraph.
...
///
pub trait StableGraphReadWriter<NodeWeight, EdgeWeight> {
    /// 
    ...
    fn serialize_graph(&self, 
        path: &str,
        graph: &StableGraphImpl<NodeWeight, EdgeWeight>) -> Result<(), io::Error>;
    ...
    fn deserialize_graph(&self, 
        path: &str) -> Result<Box<StableGraphImpl<NodeWeight, EdgeWeight>>, io::Error>;
}